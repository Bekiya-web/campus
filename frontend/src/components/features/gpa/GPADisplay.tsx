      ...
      <div className="p-6 md:p-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          <div className="text-center">
            <div className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider mb-2">{t.gpa.cumulativeGPA}</div>
          ...
          <div className="text-center border-l border-slate-200 dark:border-slate-800">
            <div className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider mb-2">{t.gpa.totalCredits}</div>
            <div className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white">{totalCredits}</div>
            <div className="text-slate-400 dark:text-slate-500 text-xs mt-1">{t.gpa.creditHours}</div>
          </div>
          <div className="text-center border-l border-slate-200 dark:border-slate-800">
          ...
          <div className="text-center border-l border-slate-200 dark:border-slate-800">
            <div className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider mb-2">{t.gpa.performanceGuide}</div>
            ...
            <div className="text-slate-400 dark:text-slate-500 text-xs mt-1">{t.gpa.grade}</div>
          </div>
        </div>
      </div>
    </Card>
