...
export const om: Translations = {
    ...
    nav: {
      home: 'Mana',
      dashboard: 'Gabatee',
      materials: 'Meeshaalee Barnootaa',
      upload: 'Fe\'i',
      discussions: 'Marii',
      news: 'Oduu',
    ...
    home: {
      ...
      heroSubtitle: 'Waltajjii Milkaa\'ina Barnoota Keessanii',
      heroDescription: 'Barattoota Itoophiyaa waliin wal qunnamu, barnoota, fi guddana',
      ...
      feature1Title: 'Meeshaalee Barnootaa',
